  ...
  return (
    <AuthLayout>
      ...
      <div className="mb-6 text-center">
        <h1 className="text-2xl font-bold text-gray-900">Welcome to Project Mango</h1>
        <p className="mt-1 text-sm text-gray-500">
          Internal weekly team progress and pulse reports
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="alex.chen@acme-corp.internal"
        ...
        <div>
          <div className="mb-1 flex items-center justify-between">
            ...
            <button type="button" className="text-xs font-medium text-mango-blue-600 hover:text-mango-blue-700">
              Forgot password?
            </button>
          </div>
          <div className="relative">
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="text-sm text-gray-600">Remember this session for 30 days</span>
        </label>
        ...
        >
          {isLoading ? 'Signing in…' : 'Sign In to Mango →'}
        </button>
      </form>
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        Need an account?{' '}
        <Link to="/sign-up" className="font-medium text-mango-blue-600 hover:text-mango-blue-700">
          Request access
        </Link>
        {' '}&bull;{' '}
        <Link to="/sign-up" className="font-medium text-mango-blue-600 hover:text-mango-blue-700">
